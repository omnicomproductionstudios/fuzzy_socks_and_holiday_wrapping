...
function animate() {
  ...
  .to('#h1', 0.5, { autoAlpha: 1, ease: Power1.easeOut}, 'frame1+=0.5')

  .addLabel('frame2', 'frame1+=4')
  .to(['#h1'], 0.5, { autoAlpha: 0, ease: Power1.easeOut }, "frame2")
  .to(['#bg2'], 0.5, { autoAlpha: 1, ease: Power1.easeOut }, "frame2")
  .to(['#h2'], 0.5, { autoAlpha: 1, y: "0", ease: Power1.easeOut }, "frame2+=0.5")

  .addLabel('frame_END', "frame2+=4")
  .to('#endframeBg', 1 ,{ top: 0, ease: Back.easeOut.config(.3)}, 'frame_END')
